...
You can use shell patterns in label names to define simple rules for mapping labels to Datadog tag names using the same simple template system used by Autodiscovery. This is supported by `DD_KUBERNETES_POD_LABELS_AS_TAGS`.
